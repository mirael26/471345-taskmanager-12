...
export default class TaskEdit {
  ...
  _createRepeatingTemplate(repeating) {
  ...
  _createColorsTemplate(currentColor) {
  ...
  _getTemplate() {
    ...
    const repeatingClassName = isTaskRepeating(repeating)
      ? `card--repeat`
      : ``;
    const repeatingTemplate = this._createRepeatingTemplate(repeating);

    const colorsTemplate = this._createColorsTemplate(color);
